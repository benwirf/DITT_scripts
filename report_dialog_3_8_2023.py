...
#####**************METHODS TO GENERATE HTML CONTENT**********************#####
    ...
    def advancedReportTableHtml(self, paddock_name):
        ...
        current_wa_3km = f'{round(current_pdk_details[3]/1000000, 3)}km² | {round(current_pdk_details[4], 2)}%'
        current_wa_5km = f'{round(current_pdk_details[5]/1000000, 3)}km² | {round(current_pdk_details[6], 2)}%'
        ...
        html_text+=f"<tr><td>Total paddock area</td><td>{current_area}km²</td><td>B</td><td>C</td></tr>"
        html_text+=f"<tr><td>Recommended carrying capacity</td><td>{current_recommended_cc}AE/yr</td><td>B</td><td>C</td></tr>"
        ...
        html_text+=f"<tr><td>Number of water points in paddock</td><td>{current_num_wpts}</td><td>B</td><td>C</td></tr>"
        html_text+=f"<tr><td>Average number of AE/water point</td><td>{current_avg_AE_per_wpt}</td><td>B</td><td>C</td></tr>"
        html_text+=f"<tr><td>3km watered area</td><td>{current_wa_3km}</td><td>B</td><td>C</td></tr>"
        html_text+=f"<tr><td>5km watered area</td><td>{current_wa_5km}</td><td>B</td><td>C</td></tr>"
        html_text+=f"<tr><td>Watered area stocking rate</td><td>{current_wa_stocking_rate} AE/km²</td><td>B</td><td>C</td></tr>"
        html_text+=f"<tr><td>Length of fencing (including terrain)</td><td>{current_fencing}km</td><td>B</td><td>C</td></tr>"
        html_text+=f"<tr><td>Length of pipeline (including terrain)</td><td>{current_pipeline}km</td><td>B</td><td>C</td></tr>"
        html_text+="</table>"
        html_text+="</body></html>"
        html_text+="<style>\
