...
from qgis.core import (QgsField, QgsProcessing, QgsFeature,
...
class TotalGrowthSummary(QgsProcessingAlgorithm):
    ...
    ############################################################################
        '''
        scale_vals is a dictionary like: {'Northern': [0, 1000, 2000, 3000], 'Southern': [0, 250, 500, 1000]}
        ...
        northern_value_list = scale_vals['Northern']
        southern_value_list = scale_vals['Southern']
