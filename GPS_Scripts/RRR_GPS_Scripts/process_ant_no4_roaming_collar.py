...
src_dir = r'C:\Users\qw2\Desktop\Ant_GPS_Collars\Anthonys_20240715\No_4_and_No_5_West'
src_file = 'No4_1200_20240715_132019.csv'
tgt_dir = r'C:\Users\qw2\Desktop\Ant_GPS_Collars\Anthonys_20240715\No_4_and_No_5_West'
...
def process_collar(input_dir, file_name, output_dir):
    ...
    buffered_pdk_lyr = QgsProject.instance().mapLayersByName('No_4_plus_100_asymmetrical')[0]
