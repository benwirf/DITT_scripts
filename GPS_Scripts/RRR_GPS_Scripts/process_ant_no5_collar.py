...
src_dir = r'C:\Users\qw2\Desktop\Ant_GPS_Collars\Anthonys_20240715\No_5_pre_split'
src_file = 'No5_1197_20240715_132642.csv'
tgt_dir = r'C:\Users\qw2\Desktop\Ant_GPS_Collars\Anthonys_20240715\No_5_pre_split'
...
def process_collar(input_dir, file_name, output_dir):
    ...
    buffered_pdk_lyr = QgsProject.instance().mapLayersByName('No_5_plus_100')[0]
    
    physical_pdk_lyr = QgsProject.instance().mapLayersByName('No5_both')[0]
