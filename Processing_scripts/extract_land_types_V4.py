...
#        return {'output_layer_check': output_layers}
        ####################Create XLSX report###########################
        ...
        if export_spreadsheet:
            ...
            outputs['Report_spreadsheet'] = processing.run("native:exporttospreadsheet", export_params, context=context, feedback=model_feedback, is_child_algorithm=True)
