...
class PostProcessRasters(QgsProcessingAlgorithm):
    '''
    ...
    def name(self):
        return "postprocessrasters"
     
    def tr(self, text):
        return QCoreApplication.translate("Processing", text)
         
    def displayName(self):
        return self.tr("Post process rasters")
    ...
    def shortHelpString(self):
        return self.tr("Load and post process multiple raster layers")
