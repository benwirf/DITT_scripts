class CustomWateredAreasWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.report_checkbox = QCheckBox('Create report spreadsheet?', self.outputs_widget)
        self.file_widget = QgsFileWidget(self.outputs_widget)
        self.file_widget.lineEdit().setPlaceholderText('Temporary Folder')
        self.file_widget.setStorageMode(QgsFileWidget.GetDirectory)
        self.outputs_layout.addWidget(self.report_checkbox)
        self.outputs_layout.addWidget(self.file_widget)
